...
export function StudioHeader() {
  ...
  return (
    <div className='sticky top-0 z-50 w-full px-4 py-4 left-0 bg-linear-to-b from-background via-background/80 to-transparent dark:from-black dark:via-black/30'>
